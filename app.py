...
if uploaded_file is not None:
   ...
   # Extraer y procesar señales
    try:
        ...
        # Crea una única figura con tres subplots, uno debajo del otro
        fig_all = make_subplots(
            rows=3, cols=1,
            subplot_titles=(f"Señal {eeg_channel_name}", f"Señal {emg_channel_name}", "Ambas Señales"),
            vertical_spacing=0.15,
            shared_xaxes=True # Esto es la clave de la sincronización
        )

        # Agrega los trazos a los subplots correspondientes
        # Subplot 1: EEG (arriba)
